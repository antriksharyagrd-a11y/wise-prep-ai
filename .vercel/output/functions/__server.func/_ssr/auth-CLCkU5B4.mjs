...
//#region node_modules/.nitro/vite/services/ssr/assets/auth-CLCkU5B4.js
...
function AuthPage() {
	...
	(0, import_react.useEffect)(() => {
		...
		const { data: authListener } = supabase.auth.onAuthStateChange((event, session) => {
			if (mounted && (event === "SIGNED_IN" || event === "SIGNED_UP") && session) nav({ to: "/resume" });
		});
		return () => {
			mounted = false;
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: mode === "signin" ? "Sign in to analyze your resume." : "Start analyzing your resume in under a minute."
					}),
